        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <Card className="p-8 bg-gradient-to-br from-card to-muted/30">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-spanish-red pl-4">
                  <h4 className="text-xl font-bold mb-2">Катастрофа при Ануалі (1921)</h4>
                ...
                <div className="border-l-4 border-spanish-red pl-4">
                  <h4 className="text-xl font-bold mb-2">Десант в Альуемасі (1925)</h4>
                  <p className="text-muted-foreground">
            ...
            <Card className="p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">СРСР</h5>
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">Інтернаціональні бригади</h5>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">Мексика</h5>
                      <p className="text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">Нацистська Німеччина</h5>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">Фашистська Італія</h5>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <h5 className="font-bold mb-2">Португалія</h5>
                      <p className="text-sm text-muted-foreground">
          ...
          >
            <Card className="p-8 bg-gradient-to-br from-card to-muted/30">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-xl font-bold mb-3">Причини:</h4>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start">
                      <span className="text-spanish-red mr-2">•</span>
                ...
                <div>
                  <h4 className="text-xl font-bold mb-3">Наслідки:</h4>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start">
                      <span className="text-spanish-red mr-2">•</span>
