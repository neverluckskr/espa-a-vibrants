...
import madridwarImage from "@/assets/madridwar.jpg";
import protestImage from "@/assets/protest.jpg";

const Index = () => {
  const timelineVideo = "https://cdn.coverr.co/videos/coverr-aerial-view-of-barcelona-1247/1080p.mp4";
    ...
    <div className="min-h-screen">
      ...
      <div className="relative isolate overflow-hidden">
        <div className="pointer-events-none absolute inset-0 -z-10">
          <video
            className="w-full h-full object-cover brightness-[1.02] saturate-110 blur-[0.3px]"
            src={timelineVideo}
            autoPlay
            loop
            muted
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/28 to-background/88" />
        </div>

        <div className="relative z-10">
          <Timeline />
          
          <section className="py-24 bg-background/85 backdrop-blur-md">
          ...
          <section className="py-24 bg-gradient-to-b from-muted/60 to-background/85 backdrop-blur-md">
            <div className="container mx-auto px-4">
